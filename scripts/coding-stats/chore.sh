...
# Categories: terminal cloud-infra secrets-auth accounts-billing dns-deploy manual-testing other
...
case "$cat" in
  terminal|cloud-infra|secrets-auth|accounts-billing|dns-deploy|manual-testing|other) ;;
